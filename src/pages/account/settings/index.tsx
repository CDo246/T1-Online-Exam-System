...
export default function Settings({
  ...
  useEffect(() => setCanUpdatePassword(oldPasswordValid && newPasswordValid && secondPasswordValid), [oldPasswordValid, newPasswordValid, secondPasswordValid])
      ...
      <CentredLayout title="Create Account">
        <form onSubmit={e => {e.preventDefault(); updatePass();}}>
          <FormBox>
            ...
            >
              <BlackButton text="Update Your Password" disabled={!canUpdatePassword}/>
            </a>
          </FormBox>
        </form>
      </CentredLayout>
